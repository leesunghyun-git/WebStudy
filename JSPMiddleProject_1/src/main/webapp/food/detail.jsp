	...
	<div class="container">
		<div class="row">
						...
						<table class="table">
							...
							<tr>
								<c:forTokens items="${vo.images }" delims="," var="img">
									<td><img src="${img }" style="width: 55px; height: 50px;"
										class="images"></td>
								</c:forTokens>
							</tr>
						</table>
					</td>
					<td colspan=2><h3>${vo.name }&nbsp;<span
			...
			<table class="table">
				...
				<tr>
					<td class="text-right"><a href="#" class="btn-sm btn-danger">좋아요</a>
						<a href="#" class="btn-sm btn-warning">찜하기</a> <a href="#"
						class="btn-sm btn-info">예약</a> <a
						href="javascript:history.back()" class="btn-sm btn-primary">목록</a>
					</td>
				</tr>
			</table>
		</div>
