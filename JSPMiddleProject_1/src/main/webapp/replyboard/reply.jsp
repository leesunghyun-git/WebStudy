		...
		<div class="row">
			...
			<table class="table">
				...
				<tr>
					...
					<td width=85%><input type=text name=subject size=20 class="input-sm" required="required"></td>
				</tr>
				<tr>
					<th width=15% class="text-center">내용</th>
					<td width=85%>
					<textarea rows=10 cols=50 name=content style="resize:none" required="required"></textarea>
					</td>
				</tr>
				<tr>
