...
window.onload=()=>{
	...
	{
		h2s[i].style.background=colors[i]
		h2s[i].innerHTML="HELLO JAVASCRIPT"
	}
...
<body>
	<div class="container">
		<div class="row">
			...
			<table class="table">
				<tr>
					<th width="35%" class="text-center">국어
					</th>
					<td width="65" >
				...
				<tr>
					<th width="35%" class="text-center">영어
					</th>
					<td width="65"><input type=text class="input-sm" id="eng" size=15></td>
				</tr>
				<tr>
					<th width="35%" class="text-center">수학
					</th>
					<td width="65"><input type=text class="input-sm" id="math" size=15></td>
				</tr>
				<tr>
					<td colspan="2" class="text-center">
						<input type=button id=btn class="btn-sm btn-primary" value="계산" onclick="gesan()">
					</td>
				</tr>
			</table>
			<h1>처리결과</h1>
			<table class="table">
				<tr>
					<th width="35%" class="text-center">총점
					</th>
					<td width="65" >
				...
				<tr>
					<th width="35%" class="text-center">평균
					</th>
					<td width="65"><input type=text class="input-sm" id="avg" size=15 readonly="readonly"></td>
				</tr>
				<tr>
					<th width="35%" class="text-center">학점
					</th>
					<td width="65"><input type=text class="input-sm" id="score" size=15 readonly="readonly"></td>
				</tr>
			</table>
		</div>
		...
		<h1>글자 조작</h1>
		<h3></h3>
		<img src="../main/mm1.gif" width=200 height=300>
		<img src="../main/mm2.gif" width=200 height=300>
