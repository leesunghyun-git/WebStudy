...
<body>
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">객체모델 <span class="caret"></span></a>
        <ul class="dropdown-menu">
      ...
      <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">EL <span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li><a href="#">EL</a></li>
          <li><a href="#">JSTL</a></li>
        </ul>
