...
async function detailData(empno){
	...
	/*
		...
		3. Tag => document.getElementByTagName("#태그명")
	
	*/
	let table=document.querySelector("#user-table")
	table.style.display=''
	document.querySelector('#empno').innerHTML=detail.empno
	document.getElementById('ename').innerHTML=detail.ename
	document.querySelector('#job').innerHTML=detail.job
	document.querySelector('#mgr').innerHTML=detail.mgr
	document.querySelector('#hiredate').innerHTML=detail.dbday
	document.querySelector('#sal').innerHTML=detail.sal
	document.querySelector('#comm').innerHTML=detail.comm
	document.querySelector('#deptno').innerHTML=detail.deptno
}
