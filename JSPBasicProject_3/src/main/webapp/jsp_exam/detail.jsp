...
<body>
	...
	<table class="table" width=1600>
		<tbody>
			<tr>
			<td align="center" width="30%" rowspan=8><img src="<%=vo.getPOSTER() %>" style="width:100%"></td>
			...
			<tr>
				<td width=15% style="color:gray">음식종료</td>
	...
	<table class="table" width=700>
		<tbody>
			<tr>
				<td align=center>
<!-- 				<div>
					<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=8ba7c1bf5703be19d075b1df1555ef2f"></script>
<script>
        ...
        <div class="option">
            <div>
                <form onsubmit="searchPlaces(); return false;">
                    키워드 : <input type="text" value="<%=vo.getADDRESS() %>" id="keyword" size="15"> 
