		...
		<div class="row">
			...
			<table class="table">
				...
				<tr>
					...
					<td>&lt;%@ page contentType="text/html;charset=UTF-8" %&gt;<br>
					text/xml : xml 변환 , text/plain : json변화
					</td>
				</tr>
				<tr>
					<td>import</td>
				...
				<tr>
					<td>buffer</td>
					<td>HTML을 저장하는 메모리 크기(출력 버퍼)</td>
					<td>
					&lt;%@ page buffer="16kb" %&gt;<br>
					브라우저에 읽어 가면 자동 flush : 접속자마다 1개만 생성<br>
					autoFlush = "true" => 자동화 처리가 된다. <br>
					</td>
				</tr>
			</table>
			<h2>include 지시자</h2>
