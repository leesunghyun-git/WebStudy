	...
	<div class="container">
		<div class="row">
			...
			<table class="table">
				<tr>
					<td class="text-right">
						입력:<input type="text" name=dong size=10 class="input-sm"><button class="btn-sm btn-success">검색</button>
					</td>
				</tr>
			</table>
			</form>
			<table class="table table-striped">
				...
				<c:forEach var="vo" items="${list }">
					<tr onclick="javascript:ok('${vo.zipcode }','${vo.address }')" style="cursor:pointer">
